...
![Version](https://img.shields.io/badge/version-18.0.2.0.0-informational)
...
|---|---|---|---|---|
| **`no_pdf_password_protection`** &mdash; *PDF Password Protection* | 18.0.2.0.0 | Free | Every PDF report you print, or attach through an email template: quotations, delivery slips, payslips, purchase orders, custom reports. Also where you choose the password source and the encryption strength. | Nothing but Odoo |
| **`no_pdf_password_protection_account`** &mdash; *PDF Password: Invoices* | 18.0.1.0.0 | Free | The invoice Odoo **emails**, which Accounting builds by a different route. Each customer's copy gets that customer's own password. | The module above, plus Accounting |
...
| Companion Module      | `no_pdf_password_protection_account` 18.0.1.0.0     |
| License               | LGPL-3                                             |
| Dependencies          | `base`                                             |
